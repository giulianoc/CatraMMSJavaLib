...
public class CatraMMSAPI implements Serializable {
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            String postBodyRequest;
			{
                ...
                joObj.put("appCaptureAndProxy", appCaptureAndProxy);
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            joUserAPIKey.put("appCaptureAndProxy", newAppCaptureAndProxy);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            joDeliveryServer.put("publicIP", publicIP);
            joDeliveryServer.put("internalIP", internalIP);
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            String queryChar = "?";
            if (startIndex != null && startIndex.longValue() != -1)
            {
                mmsURL += (queryChar + "start=" + startIndex);
                queryChar = "&";
            }
            if (pageSize != null && pageSize.longValue() != -1)
            {
                mmsURL += (queryChar + "rows=" + pageSize);
                queryChar = "&";
            }
            ...
            {
                mmsURL += (queryChar + "serverIP=" + java.net.URLEncoder.encode(serverIP, "UTF-8"));
                queryChar = "&";
            }
            if (hostname != null && !hostname.isBlank())
            {
                mmsURL += (queryChar + "hostname=" + java.net.URLEncoder.encode(hostname, "UTF-8"));
                queryChar = "&";
            }
            if (labelOrder != null && !labelOrder.isBlank())
            {
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            if(jaWorkspaceInfo.has("userAPIKey"))
            {
                ...
                workspaceDetails.setAppCaptureAndProxy(joUserAPIKey.optBoolean("appCaptureAndProxy", false));
            ...
            throws Exception
    {
        ...
        try {
            ...
            if (mediaItemInfo.has("userData") && !mediaItemInfo.isNull("userData"))
                mediaItem.setJoUserData(mediaItemInfo.getJSONObject("userData"));
            ...
            throws Exception
    {
        try {
            ...
            if (rtmpChannelConfInfo.isNull("playURLDetails"))
